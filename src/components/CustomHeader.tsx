...
function CustomHeader({ title }: LayoutHeaderProps) {
  return (
    <motion.div
    ...
    >
      <motion.h1
        className="col-span-6 w-full text-2xl lg:col
        -span-1"
      ...
      <div className="col-span-2 flex items-center space-x-2 px-1 max-sm:pl-2 lg:col-span-1 lg:justify-start lg:pl-2">
